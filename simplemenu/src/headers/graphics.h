...
void drawShadedGameNameOnScreenCustom(char *buf, int position, int isFavorite);
void drawNonShadedGameNameOnScreenCustom(char *buf, int position, int isFavorite);
